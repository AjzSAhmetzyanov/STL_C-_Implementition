...
namespace s21{
    template<class T, class Container = s21::Vector<T> > // T - тип данных для сохранения в стеке, 
        ...
        class Stack{
            ...
            public:
                ...
                const reference top() const { //Возвращает ссылку на элемент в верхней части stack.
                    return (_container.back());
                };
